...
class doc_labeling(object):
    ...
    def doc_to_vec(self,documents):
        ...
        model.save('model_dailynews_deepcut_doc2vec__1870') # Model name: model_dailynews_deepcut_doc2vec__1870
...
if __name__ == '__main__':
    ...
    doclb = doc_labeling()
    #a = doclb.get_body_eco(1870)
    b = doclb.get_body_edu(1870)
    c = doclb.get_body_ent(1870)
    #d = doclb.get_body_fore(1870)
    e = doclb.get_body_it(1870)
    f = doclb.get_body_spo(1870)
