# -*- coding: utf-8 -*-
"""
Created on Sun Jun 16 15:15:59 2019
...
if __name__ == '__main__':
    ...
    ####### Get data from CSV ########
    #economic = pd.read_csv('/Users/USER/Anaconda/AnacondaProjects/Automatic_Labeling_ThaiNewsArticles_by_PV/economic.csv')
    education = pd.read_csv('/Users/USER/Anaconda/AnacondaProjects/Automatic_Labeling_ThaiNewsArticles_by_PV/education.csv')
    entertainment = pd.read_csv('/Users/USER/Anaconda/AnacondaProjects/Automatic_Labeling_ThaiNewsArticles_by_PV/entertainment.csv')
    it = pd.read_csv('/Users/USER/Anaconda/AnacondaProjects/Automatic_Labeling_ThaiNewsArticles_by_PV/it.csv')
    sports = pd.read_csv('/Users/USER/Anaconda/AnacondaProjects/Automatic_Labeling_ThaiNewsArticles_by_PV/sports.csv')
